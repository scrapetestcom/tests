...
if (wsBrowser) {
    browser = await chromium.connectOverCDP(wsBrowser);
    ...
    if (!proxyIp.startsWith('socks5://') || proxyIp.startsWith('http')) {
...
// Navigate and wait for the main document response (60s timeout)
const finalResponse = await page.goto(url, {waitUntil: 'domcontentloaded', timeout: 60000});
